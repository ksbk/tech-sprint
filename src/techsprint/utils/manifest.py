...
def write_run_manifest(
    *,
    ...
    payload: dict[str, Any] = {
        ...
        "captions_source_policy": job.verbatim_policy or job.settings.verbatim_policy,
        "verbatim_mode": job.verbatim_mode if job.verbatim_mode is not None else True,
        "verbatim_check": job.verbatim_check,
        "steps": _serialize_steps(steps),
        "artifacts": {
            "script": _artifact_entry(artifacts.script),
            "audio": _artifact_entry(artifacts.audio),
            "asr": _artifact_entry(artifacts.asr),
